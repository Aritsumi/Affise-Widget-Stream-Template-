...
$url_api_php = 'https://api-admachina.affise.com/3.0/stats/conversions?API-Key=8c7dbc24215a9fe8f09979edcde633b0';
...
<body>
    <script>
        ...
        function html_out() {
            ...
            var console = $.ajax(settings).response;
